...
<div class="row">
     <!--begin::Portlet-->
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
                <form class="kt-form kt-form--label-right" method="post" action="{{url('update_bulk_material')}}">
                     {{ csrf_field() }}
                      <input type="hidden" name="material_id" value="{{ $bulk_material['id'] }}">
                ...
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text" name="material_name" value="{{ $bulk_material['material_name'] }}" id="material_name" placeholder="Bulk Material Name" required maxlength="99">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text" name="material_code" value="{{ $bulk_material['material_code'] }}"  id="material_code" placeholder="Bulk Material Code" required maxlength="10">
                            <span class="form-text" style="color:red">
