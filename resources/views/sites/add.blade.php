...
<div class="row">
     <!--begin::Portlet-->
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
                <form class="kt-form kt-form--label-right" method="post" action="{{url('add_site')}}">
                     {{ csrf_field() }}
                ...
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text" name="site_name" value="{{ old('site_name') }}" id="site_name" placeholder="Site Name" required maxlength="191">
                        ...
                        <div class="col-10">
                            <div class="kt-radio-inline">
                                <label class="kt-radio">
                                    <input type="radio" name="site_type" checked="checked"  value="indoor"> Indoor
                                    <span></span>
                                </label>
                                <label class="kt-radio">
                                    <input type="radio" name="site_type" value="outdoor"> Outdoor
                                    <span></span>
                                </label>
                            </div>
                        </div>
