                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                <a href="{{ url('medicines')}}" aria-expanded="true"><i class="ti-dashboard"></i><span>Medicines</span></a>
                            </li>
                            <li class="active">
                                <a href="{{ url('patients')}}" aria-expanded="true"><i class="ti-dashboard"></i><span>Patients</span></a>
                            </li>
                            <!--<li>
