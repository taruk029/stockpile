...
<div class="row">
    ...
    <div class="kt-portlet__head-actions">
        &nbsp;
        <a href="{{ url('add_user')}}" class="btn btn-brand btn-elevate btn-icon-sm">
        ...
        <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-sm btn-clean btn-icon btn-icon-md" href="{{url('edit_user/'.$row->user_id)}}" title="Edit User Details" >
                            <i class="fa fa-edit"></i>
                        </a>
                        @if($row->is_active==1)
                        <a href="{{url('change_user_status/'.$row->user_id.'/0')}}" title="Deactivate User" onclick="return confirm('This user will be deactivated. Are you sure to proceed?');">
                                <i class="fa fa-times"></i>
                              </a>
                        @else
                        <a href="{{url('change_user_status/'.$row->user_id.'/1')}}" title="Activate User">
