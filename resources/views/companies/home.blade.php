...
<div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
    ...
    <div class="col-md-6 col-lg-6 col-xl-6">
        <center>
            <img src="{{ asset('assets/media/users/noimage.jpg') }}" class="dash_img img-responsive" id="image_one"></center>
    </div>
    <div class="col-md-6 col-lg-6 col-xl-6">
        <center><img src="{{ asset('assets/media/users/noimage.jpg') }}" class="dash_img img-responsive" id="image_two"></center>
    </div>
    </div>
    </div>
    </div>
...
<div class="kt-portlet">
        ...
        <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
            ...
            <tbody>
                ...
                <tr>
                    <td><a href="javascript:void(0)" onclick="javascript:load_images({{$row->date_metron_id}})" title="Click here to load the images.">{{ $row->pile_reference_id  }}</a></td>
                    ...
                    <td>
                    <a class="btn btn-sm btn-clean" href="javascript:void(0)" onclick="javascript:open_modal({{$row->date_metron_id}}, '{{$row->pile_reference_id}}')" title="Request Enquiry" >
                        Request Enquiry
                    </a>
                    </td>
                </tr>  
...
function load_images(id)
{
    if(id)
    {
        setTimeout( $.blockUI({ message: "<i class='fa fa-2x fa-spinner fa-spin' aria-hidden='true' ></i> &nbsp; <h6>Loading... a moment please.</h6>" })}, 3000);      
        $.ajax({
            url: "{{ url('load_images') }}",
            type: 'GET',
            data: {id:id},            
