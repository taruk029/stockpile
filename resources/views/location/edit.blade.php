...
<div class="row">
     <!--begin::Portlet-->
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
                <form class="kt-form kt-form--label-right" method="post" action="{{url('update_location')}}">
                     {{ csrf_field() }}
                ...
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text" name="location_name" value="{{ $location['name'] }}" id="location_name" placeholder="Location Name" required maxlength="191">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text" name="address" value="{{ $location['address'] }}" id="address" placeholder="Address"  maxlength="200"  required="required">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text" name="state" value="{{ $location['state'] }}" id="state" placeholder="State"  maxlength="50" required="required">
                             <span class="form-text text-muted">
                                @if ($errors->has('state'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text" name="zip" value="{{ $location['zip'] }}" id="zip" placeholder="Zip Code" required onkeypress="return NumbersOnly(event,this)"  maxlength="6">
                             <span class="form-text" style="color:red">
                                @if ($errors->has('zip'))
                        ...
                        <div class="col-10">
                            <select class="form-control" id="country" name="country" required="required">
                                ...
                                @foreach($country as $row)
                                        <option <?php if($location['country']==$row->id) echo "selected"; ?> value="{{ $row->id }}" >{{ $row->name }}</option>
                                @endforeach
                            </select>
                             <span class="form-text text-muted">
