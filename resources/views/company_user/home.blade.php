...
<div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
    ...
    <div class="col-md-6 col-lg-6 col-xl-6">
        <center><img src="{{ asset('public/assets/media/users/noimage.jpg') }}" class="dash_img img-responsive" id="image_one"></center>
    </div>
    <div class="col-md-6 col-lg-6 col-xl-6">
        <center><img src="{{ asset('public/assets/media/users/noimage.jpg') }}" class="dash_img img-responsive" id="image_two"></center>
    </div>
    </div>
    </div>
    </div>
...
<script src="{{ asset('public/assets/js/demo8/pages/dashboard.js') }}" type="text/javascript"></script>
